...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-adegraphics-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10678&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-adegraphics-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-adegraphics` can be installed with:

```
conda install r-adegraphics
```

It is possible to list all of the versions of `r-adegraphics` available on your platform with:
